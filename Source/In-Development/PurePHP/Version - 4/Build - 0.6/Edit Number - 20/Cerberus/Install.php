...
echo ("
	...
	* Administrator Electronic Mail Address:<BR>
	<INPUT TYPE=\"post_administrator_email_address\" MAXLENGTH=\"100\"><BR>	
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Articles','0','3','1','<CENTER><B>Articles</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Banned','0','4','1','<CENTER><B>Banned IP Addresses</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Cerberus','1','1','1','<CENTER><B>Cerberus</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Files','1','3','1','<CENTER><B>Files</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Language','1','6','1','<CENTER><B>Set Language</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Modules','0','1','1','<CENTER><B>Modules</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Members','0','2','1','<CENTER><B>Member Panel</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Member_List','1','4','1','<CENTER><B>Newest Members</B></CENTER><HR>')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_PREFIX}_blocks(block_file_name,block_alignment,block_row,block_file_name_status,block_title)VALUES('Shouts','1','5','1','<CENTER><B>Shout Messages</B></CENTER><HR>')");
...
copy("System/Default/Friend/Friend.cerb","Member/$_POST_ADMINISTRATOR_USERNAME/E-Mail/cerberuscms[at]protonmail.com");
