...
CREATE TABLE \"$_INSTALL_FORM_POST_HOSTNAME_DATABASE_PREFIX\"_ahref (
...
CREATE TABLE \"$_INSTALL_FORM_POST_HOSTNAME_DATABASE_PREFIX\"_applications (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE \"$_INSTALL_FORM_POST_HOSTNAME_DATABASE_PREFIX\"_articles (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE \"$_INSTALL_FORM_POST_HOSTNAME_DATABASE_PREFIX\"_banned_ip_addresses (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
for ($i = 0; $i < sizeof($_MAIN_INSTALLATION_DEFAULT_SQL_TABLES); $i++)
	mysql_query($_MAIN_INSTALLATION_DEFAULT_SQL_TABLES[$i]);
