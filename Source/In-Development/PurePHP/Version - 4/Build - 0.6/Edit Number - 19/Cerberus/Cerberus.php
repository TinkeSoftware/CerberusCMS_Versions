...
//$_CERBERUS_DATABASE_CONNECTION						= new PDO(mysql:'$_ACCESS_DATABASE_HOSTNAME;dbname=$_ACCESS_DATABASE_NAME', $_ACCESS_DATABASE_USERNAME, $_ACCESS_DATABASE_PASSWORD);
